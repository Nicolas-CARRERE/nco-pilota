...
No database here: this service fetches and parses, and the Node API persists. A
database URL in this file is what once let a local default stand in for a real
database, and what kept a second writer alive next to the one that owns the schema.
"""
